...
currentChannel.subscribe(msg=>{
  ...
  if(currentGroup && groupKeys[currentGroup]) content = xorDecrypt(content, groupKeys[currentGroup]);
  displayMessage(content);
  saveMessageToSharedStorage(msg.data);
});
...
function sendMessage(){
  ...
  if(currentGroup && groupKeys[currentGroup]) msg = xorEncrypt(msg, groupKeys[currentGroup]);
